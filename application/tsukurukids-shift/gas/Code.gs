...
function initializeSpreadsheet() {
  ...
  seed('学生スタッフ情報',
    ...
    [
      ...
      ['山田花子', '沖縄大学',     '2年', '経済', '',     '',     '',     '可'],
      ['佐藤健',   '沖縄国際大学', '1年', '法学', '',     '不可', '',     ''],
      ['鈴木一郎', '琉球大学',     '2年', '工学', '',     '',     '不可', '可'],
      ['田中美咲', '沖縄大学',     '3年', '教育', '不可', '',     '',     '可'],
    ]);

  seed('学校時間割',
    ['学校', 'クラス', 'コース', '月', '火', '水', '木', '金'],
    [
      ['琉球大学',     '3年', '情報', '15:00', '15:00', '15:00', '15:00', '15:00'],
      ['沖縄大学',     '2年', '経済', '15:00', '15:00', '15:00', '15:00', '15:00'],
      ['沖縄国際大学', '1年', '法学', '15:00', '15:00', '15:00', '15:00', '15:00'],
      ['琉球大学',     '2年', '工学', '15:00', '15:00', '15:00', '15:00', '15:00'],
      ['沖縄大学',     '3年', '教育', '15:00', '15:00', '15:00', '15:00', '15:00'],
    ]);
  ...
  seed('勤務エリア',
    ...
    [
      ...
      ['山田花子', '', '那覇校', '那覇校', '那覇校', '那覇校', '那覇校', '那覇校'],
      ['佐藤健',   '', '那覇校', '那覇校', '那覇校', '那覇校', '那覇校', '那覇校'],
      ['鈴木一郎', '', '那覇校', '那覇校', '那覇校', '那覇校', '那覇校', '那覇校'],
      ['田中美咲', '', '那覇校', '那覇校', '那覇校', '那覇校', '那覇校', '那覇校'],
    ]);
  ...
  seed('ログインアカウント情報',
    ...
    [
      ...
      ['山田花子', 'yamada@example.com',    'pass1234'],
      ['佐藤健',   'sato@example.com',      'pass1234'],
      ['鈴木一郎', 'suzuki@example.com',    'pass1234'],
      ['田中美咲', 'tanaka@example.com',    'pass1234'],
    ]);
