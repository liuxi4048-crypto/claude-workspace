...
| # | 役職 | ファイル | 常駐 | 発動トリガー |
|---|---|---|---|---|
| L0 | **Chairman** | [chairman.md](chairman.md) | ✗ | `フェーズ完了` `CEO判断`（裁定） |
| L1 | **CEO-Ext** | [ceo_ext.md](ceo_ext.md) | ✗ | `プロジェクト開始` `CEO判断` `提案審議` |
| L1 | **CEO-Int** | [ceo_int.md](ceo_int.md) | ✗ | `プロジェクト開始` `CEO判断` `提案審議` |
| L2 | **COO** | [coo.md](coo.md) | ✅ | `作業開始` `作業終了` `タスク確認` |
...
ルート③: メンバーが次のメンバーへバトンタッチ
    例）CPOが要件定義完了 → 「CTOへバトンタッチ」と宣言
```
