...
- **毎週土曜 9:00（日本時間）に自動運転**（Routine 設定済み・2026-07-19）: 新しいセッションが自動起動して `/content-factory` 相当の週次運転（執筆・パイプライン・進捗更新・push）を行い、結果をプッシュ通知する。手動で追加起動したいときは `/content-factory` と打つ
